...
class disposableHostGenerator():
    sources = [
        ...
        {'type': 'list', 'external': True, 'src': 'https://raw.githubusercontent.com/disposable/static-disposable-lists/master/mail-data-hosts-net.txt'},
        {'type': 'list', 'external': True, 'src': 'https://raw.githubusercontent.com/wesbos/burner-email-providers/master/emails.txt'},
        {'type': 'list', 'external': True, 'src': 'https://raw.githubusercontent.com/disposable/disposable/master/blacklist.txt'},
